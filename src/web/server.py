                        ...
                        try:
                            ...
                            def sync_status_callback(msg: str):
                                asyncio.run_coroutine_threadsafe(
                                     manager.broadcast(json.dumps({"type": "status", "message": msg})),
                                     loop
                                )
                                
                            stats = await loop.run_in_executor(None, config_manager.reload_all_configs, planes_list, sync_status_callback)
